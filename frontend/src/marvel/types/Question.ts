...
export interface DamageAllEnemies {
  tag: 'DamageAllEnemies'
}
...
export const damageAllEnemiesDecoder = JsonDecoder.object<DamageAllEnemies>({ tag: JsonDecoder.isExactly('DamageAllEnemies') }, 'DamageAllEnemies')
...
export const chooseHealDecoder = JsonDecoder.object<ChooseHeal>({
  tag: JsonDecoder.isExactly('ChooseHeal'),
}, 'ChooseHeal')
...
export const chooseOneLabelChoiceDecider = JsonDecoder.object<ChooseOneLabelChoice>({ tag: JsonDecoder.isExactly('ChooseOneLabelChoice') }, 'ChooseOneLabelChoice')
...
export const abilityChoiceDecoder = JsonDecoder.oneOf<AbilityChoice>([
  ...
  payDecoder,
  runDecoder,
  chooseOneLabelChoiceDecider,
  readyIdentityDecoder,
  runAbilityDecoder,
  recoverDecoder,
  attackDecoder,
  damageAllEnemiesDecoder,
  healDecoder,
  createEffectDecoder,
  allyAttackDecoder,
  allyThwartDecoder,
...
export interface ChooseOneLabelChoice {
  tag: 'ChooseOneLabelChoice'
}
