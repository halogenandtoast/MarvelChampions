...
sandman :: CardDef
sandman =
  unique $ (minion "01102" "Sandman" [Criminal, Elite] [Boost, Boost] Rhino 1)
...
armoredGuard = (minion "01120" "Armored Guard" [Mercenary] [Boost] Klaw 3)
  { cdKeywords = fromList [Guard, Toughness]
  }

weaponsRunner :: CardDef
weaponsRunner = (minion "01121" "Weapons Runner" [Mercenary] [Star] Klaw 2)
  { cdKeywords = singleton Surge
  }

radioactiveMan :: CardDef
radioactiveMan = unique $ minion
  "01129"
  "Radioactive Man"
...
whiplash :: CardDef
whiplash =
  unique $ (minion "01172" "Whiplash" [Criminal] [Boost, Boost] IronManNemesis 1
           )
