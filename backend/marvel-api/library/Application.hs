...
import Api.Handler.Marvel.Cards
import Api.Handler.Marvel.Decks
import Api.Handler.Marvel.Games
import Api.Handler.Marvel.Heroes
import Api.Handler.Marvel.PendingGames
import Api.Handler.Marvel.Replay
import Api.Handler.Marvel.Undo
...
handleOptions app req sendResponse =
  case (requestMethod req, lookup "Origin" (requestHeaders req)) of
    ("OPTIONS", Just origin) -> sendResponse
